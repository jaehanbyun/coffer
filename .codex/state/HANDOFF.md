...
- Status: plan 0019 blocked externally; plan 0020 active; local production observability, disposable
  ...
  request-ID/OpenAPI implementation next
...
Add a bounded request-ID middleware for the Falcon control API, prove valid
incoming preservation plus generated fallback without changing
Keystone-owned outer 401 behavior, then write `api-ref/openapi.json`.
