...
1. Partially completed: real PostgreSQL and MariaDB semantics pass; two edge/admission replicas, production database operations, and non-bypassable Distribution write ingress remain.
