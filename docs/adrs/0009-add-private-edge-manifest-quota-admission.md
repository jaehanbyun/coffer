...
12. Added revision `0004_inventory_import`, strict canonical artifact/hash verification, and a singleton empty-ledger import. SQLite, PostgreSQL 17.10, and MariaDB 11.4.12 prove full rollback after a forced second-manifest failure, concurrent one-writer/exact-no-op convergence, different-baseline refusal, exact descriptor reference counts, and honest over-limit usage without admission enablement.
